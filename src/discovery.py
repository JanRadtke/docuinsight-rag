...
class DiscoveryEngine:
    ...
    def __init__(self, retriever: Retriever, agent: AdvancedAgent = None):
        """
        Args:
    ...
    def run_batch_discovery(self, file_list=None, progress_callback=None, max_pages_per_doc=5):
        """
    ...
    def _generate_quick_summary(self, filename, context):
    ...
    def _generate_trend_report(self, summaries):
    ...
    def _generate_insights(self, summaries):
    ...
    def export_results_to_markdown(self, results):
