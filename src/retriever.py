...
class Retriever:
    ...
    def _tokenize(self, text, language="en"):
    ...
    def _bm25_search(self, query, top_k=10, query_lang="en"):
    ...
    def _hybrid_search(self, question, top_k=10):
        """
        ...
        ranked_ids = sorted(rrf_scores, key=rrf_scores.get, reverse=True)[:rerank_k]
    ...
    def _multilingual_hybrid_search(self, queries: dict, top_k: int = 10) -> list:
        ...
        ranked_ids = sorted(all_rrf_scores, key=all_rrf_scores.get, reverse=True)[:rerank_k]
    ...
    def _build_where_filter(self, filename=None, include_images=False):
    ...
    def _apply_structured_sampling(self, results_list, intro_pages, middle_pages, discussion_pages):
    ...
    def retrieve_multiple_documents(self, filenames, total_token_budget=100000, strategy="balanced"):
        """
    ...
    def retrieve_intro_only(self, filenames, intro_pages=3):
    ...
    def match_documents_by_entities(self, entities, intro_pages=2):
        """
    ...
    def get_document_summary(self, filename, max_pages=5):
        """
...
def extract_filenames_from_prompt(prompt, max_files=3):
    """
