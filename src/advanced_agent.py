...
"""},
    ...
    def summarize(self, context_text: str) -> str:
        """
...
{context_text}"""
    ...
    def identify_comparison_criteria(self, intro_contexts: dict, num_documents: int = 2) -> list[str]:
        """
    ...
    def verify_citation_integrity(self, draft_text: str, doc_ranges: list) -> str:
        """
        The 'Truth Layer'.
    ...
    def compare_documents(self, context_text: str, num_documents: int = 2, criteria: list[str] | None = None) -> str:
        """
    ...
    def extract_facts(self, question: str, raw_context: str, intent: str | None = None, entities: list | None = None) -> dict:
        """
...
"""
    ...
    def draft_answer(self, question: str, extracted_facts: dict, target_language: str | None = None) -> str:
        """
...
"""
    ...
    def critique_draft(self, question: str, facts: list, draft: str, intent: str | None = None) -> dict:
        """
...
- Be conservative: when in doubt, PASS."""
    ...
    def revise_draft(self, question: str, facts: list, draft: str, critic_feedback: str, target_language: str | None = None) -> str:
        """
...
Please revise the draft according to the feedback. Keep what is correct, fix what is wrong."""
    ...
    def verify_citations(self, draft_answer: str, raw_context: str) -> str:
        """
