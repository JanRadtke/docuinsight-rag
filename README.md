...
Off-the-shelf RAG platforms and frameworks solve retrieval out of the box — but hide the decisions that matter in production: how retrieval is scored, when to retry, and why a query gets blocked. DocuInsight was built from scratch to keep every architectural decision visible and tuneable. The evaluation section below compares both systems on the same testset.
...
The biotech testset uses these open-access papers (not included in the repo – download the PDFs from PubMed and place them in `input/`). All papers are indexed on PubMed — one source, no journal-specific paywalls:

| # | Authors | Title | PubMed |
|---|---------|-------|--------|
| 1 | López-Otín et al. 2023 | Hallmarks of aging: An expanding universe | [PMID 36599349](https://pubmed.ncbi.nlm.nih.gov/36599349/) |
| 2 | Tartiere et al. 2024 | The hallmarks of aging as a conceptual framework | [PMID 38292053](https://pubmed.ncbi.nlm.nih.gov/38292053/) |
| 3 | Chen et al. 2025 | Immunosenescence in aging and neurodegenerative diseases | [PMID 41299782](https://pubmed.ncbi.nlm.nih.gov/41299782/) |
| 4 | Li et al. 2023 | Interactions between mitochondrial dysfunction and other hallmarks | [PMID 37497653](https://pubmed.ncbi.nlm.nih.gov/37497653/) |
| 5 | Kaeberlein et al. 2023 | Evaluation of off-label rapamycin use in 333 adults | [PMID 37191826](https://pubmed.ncbi.nlm.nih.gov/37191826/) |
| 6 | Saliev et al. 2025 | Targeting senescence: Senolytics and senomorphics | [PMID 40563501](https://pubmed.ncbi.nlm.nih.gov/40563501/) |
